		...
		<div className="w-full relative min-h-screen">
			...
			<section id="who" className="bg-white py-20">
				<div className="w-full max-w-6xl mx-auto flex items-stretch justify-between gap-12">
					<article className="w-1/2">
						...
						<h1 className="text-sec w-full font-semibold mt-8 text-4xl leading-[45px]">
					...
					<article className="w-1/2">
						<p className="leading-[30px]">
							Our company has cultivated a resilient legal system that is adept at managing and resolving complex legal matters. Our founders personally oversee each case and implement a
							hands-on strategy to ensure its successful resolution. We have a diverse customer base that spans numerous industries and countries, and we offer guidance to both
							individuals and businesses alike.
						</p>

						<p className="text-xl font-semibold my-8 text-black">
							“The firms commitment is to provide transparent, honest and flexible legal service to its client- a reasonable cost for state of the art legal services which brings clients
			...
			<section className="pb-20">
				<div className="w-full max-w-6xl mx-auto flex justify-between items-center gap-4">
					...
					<div className="px-8 border-l-[1px]">
						<div className="w-8 h-8 mb-4">
			...
			<section className="w-full h-[60vh] philosophy_banner flex flex-col justify-end max-w-6xl mx-auto mb-24 p-8">
				<div className="w-1/2 ">

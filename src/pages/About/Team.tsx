...
const Team = () => {
	return (
		<>
			<Header sx="!relative" />
			<div className="min-h-screen px-4 max-w-6xl mx-auto py-16">
				<Breadcrumbs links={links} />

				<div className="w-full grid mt-16 md:grid-cols-2 gap-8">
					...
					{teamData?.map((member, index) => (
						<div
							...
							<div className="w-auto p-5">
								<p className="text-sm md:text-[16px] text-sec font-poppins">{member.role}</p>

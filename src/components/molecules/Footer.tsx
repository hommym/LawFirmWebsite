...
const Footer = () => {
	return (
		<footer className="w-full px-4 min-h-[50vh] pt-20 pb-10 footer_bg">
				...
				<div className="flex items-center justify-between ">
					<div className="w-full md:w-[70%]">
						<div className="w-full pb-8 border-b-[1px]">
							...
							<div className="md:w-1/2 border-[1px] rounded-[5px] flex items-center justify-between h-12 mt-8">
						...
						<nav className="my-5 w-full md:w-3/5 flex items-center justify-between">
